      ...
      <div class="container d-flex align-items-center">
        ...
        <nav id="navbar" class="navbar order-last order-lg-0">
          <ul>
            ...
            <li><a class="active" href="events.html">Contenido</a></li>
        ...
        <a href="loginn.php" class="get-started-btn">Ingresar</a>
      </div>
    </header>
    <!-- End Header -->
    ...
    <main id="main">
      ...
      <div class="breadcrumbs" data-aos="fade-in">
        <div class="container">
          <h2>Videos</h2>
          <p>
            Esta sección muestra algunos videos que se presentan en los cursos
          </p>
        </div>
      </div>
      <!-- End Breadcrumbs -->
